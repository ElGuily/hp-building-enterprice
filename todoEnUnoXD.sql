...
INSERT INTO `empleado` VALUES (1,'facunare','arechaga.facundoet36@gmail.com','1234',46701107,'facundo',NULL),(2,'facundoare','arechaga.facundoet36@gmail.com','1234',46701107,'facundo',NULL);
...
INSERT INTO `pc` VALUES (1,'compu1','rx560','Gamer',500.00,3),(2,'compu2','rx570','Diseño',600.00,3),(3,'compu3','rx550','Gamer',550.00,3),(4,'compu Oficina','ab20','Oficina',700.00,2),(5,'null','HP2004','DiseÃ±o',222.00,2),(6,'null','HP2004','DiseÃ±o',222.00,2),(7,'compuDiseÃ±adoraHP','HP2004','Gamer',250.00,2);
...
INSERT INTO `usuario` VALUES (1,'admin','admin'),(2,'facunare','1234');
...
BEGIN
	insert into PC(nombre_pc, modelo, categoria, precio, cant_comp_importados) values(nom, model, cat, pcio, cci);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	select * from PC where categoria = cat;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2022-11-08 21:25:54
