...
create table PC(
	...
	foreign key(categoria) references Categoria(nombre_cat)
);

insert into PC(nombre_pc, modelo, categoria, precio, cant_comp_importados) values("compu3", "rx550", "Gamer", 550.00, 3);
insert into PC(nombre_pc, modelo, categoria, precio, cant_comp_importados) values("compu Oficina", "ab20", "Oficina", 700.00, 2);
drop table PC;

call verCompu("Diseño");
select * from PC;
...
insert into categoria(nombre_cat) values("Diseño");
/*
