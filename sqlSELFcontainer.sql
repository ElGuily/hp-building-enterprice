...
BEGIN
	insert into PC(nombre_pc, modelo, id_categoria, precio, cant_comp_importados, rgb, all_in_one, refri_liquid) values(nom, model, cat, pcio, cci, rgba, aou, rl);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2022-11-10 21:51:18
