...
INSERT INTO `empleado` VALUES (1,'facunare','arechaga.facundoet36@gmail.com','1234',46701107,'facundo',532.00),(2,'facundoare','arechaga.facundoet36@gmail.com','1234',46701107,'facundo',3366.00),(3,'admin','admin@gmail.com','admin',45463655,'admin',0.00);
...
CREATE TABLE `pc` (
  ...
  `cant_comp_importados` int DEFAULT NULL,
...
BEGIN
	insert into carrito values (nom, us, 1);
